...
export default function EmployeeDetail({ forcedTab }: { forcedTab?: TabType }) {
  ...
  const { data: salaryData } = useQuery<{ salaryRecord: SalaryRecord }>(
    GET_SALARY_RECORD,
    {
  ...
  useQuery<{ leaveBalances: Array<{ leave_type: string; balance: number }> }>(
    GET_LEAVE_BALANCES,
    {
      variables: { employee_id: id },
      skip: activeTab !== "Leaves",
    ...
    <div className="ed-container">
              ...
              <div className="ed-field">
                ...
                <div className="ed-value">
                  {formatDateForDisplay(
                    employee.work_detail?.date_of_joining,
                  ) || "—"}
                </div>
              </div>
              <div className="ed-field">
            ...
            <div className="ed-filter-bar">
              <div className="ed-filter-item">
                ...
                <select className="ed-select">
                  <option>All</option>
                  {leaveTypes.map(
                    (lt: { name: string; total_days: number }) => (
                  ...
                  <div className="ed-modal-body">
                    ...
                    <div className="ed-filter-item">
                      ...
                      <select
                        className="ed-select"
                        value={
                          applyForm.leave_type || leaveTypes[0]?.name || ""
                        }
                        onChange={(e) =>
                          setApplyForm({
                            ...applyForm,
                  ...
                  <div className="ed-modal-foot">
                    ...
                    <button
                      ...
                      onClick={async () => {
                        ...
                        const day_breakdowns = applyDaysData.map((d) => ({
                          date: d.date,
                          leave_type: d.type,
                        }));
                        ...
                        try {
                          ...
                          setStatus({
                            message: error.message || "Error applying",
                            type: "error",
                          });
                        }
                      }}
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  const overlap = existMv.some((m) => {
                    ...
                    if (
                      m.movement_date.split("T")[0] !== moveForm.movement_date
                    )
                      return false;
                    const [exOH, exOM] = m.out_time.split(":").map(Number);
                    const [exIH, exIM] = (m.in_time || "23:59")
                      .split(":")
                      .map(Number);
                  ...
                  if (overlap) {
                    setMStatus({
                      message:
                        "You already have a movement scheduled during this time.",
                      type: "error",
                    });
                    return;
                  }
      ...
      {showAttSettingsModal && (
        <div
          ...
          onClick={() => setShowAttSettingsModal(false)}
        >
                      ...
                      <tr key={row.day}>
                        ...
                        <td className="ed-td-time">
                          {isEditing ? (
                            ...
                            `${formatTo12Hr(row.checkin)} - ${formatTo12Hr(row.checkout)}`
                          )}
                        </td>
            ...
            <div className="ed-modal-body" style={{ padding: 0 }}>
              ...
              <div className="ed-status-modal-note">
                ...
                <p>
                  ...
                  latest information immediately. Please wait for a few minutes
                  or check back later for the updated results.
                </p>
              </div>
            </div>
      ...
      {showUpdateShiftTimeModal && (
        <div
          className="ed-modal-overlay"
          onClick={() => setShowUpdateShiftTimeModal(false)}
        >
          <div
            className="ed-modal-card"
            style={{ maxWidth: 550 }}
