...
export default function LeaveTypesSection() {
  const { data, loading, refetch } = useQuery<{
    settings: { leave_types: LeaveType[] };
  }>(GET_SETTINGS, {
    fetchPolicy: "network-only",
  });
  const [upsertLeaveType, { loading: saveLoading }] = useMutation(
    UPSERT_LEAVE_TYPE,
    {
      onCompleted: () => {
        refetch();
      ...
      await upsertLeaveType({
        variables: {
          input: {
            ...
            max_consecutive_leaves: parseInt(
              form.max_consecutive_leaves || "0",
            ),
      ...
      <div className="ds-card">
        <div className="ds-card-header">
          <div>
            ...
            >
              Configure leave rules and categories.
            </p>
          </div>
          <button
              ...
              <table className="ds-table">
                ...
                <tbody>
                  {leaveTypes.map((lt) => (
                    <tr key={lt.id}>
                      <td>
                        <span className="ds-code-pill">{lt.code}</span>
                      </td>
                      <td>
                      ...
                      <td>
                        <span>{lt.max_consecutive_leaves || 0}</span>
                      </td>
                      <td>
                        <div
                          style={{
            ...
            <div className="ds-modal-body">
              ...
              <div className="ds-field-row">
                <div className="ds-field">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, leave_category: e.target.value }))
                    }
                  >
                ...
                <div className="ds-field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({
                        ...p,
                        max_consecutive_leaves: e.target.value,
                      }))
                    }
                  />
                </div>
                ...
                <div className="ds-field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({
                        ...p,
                        days_before_apply: e.target.value,
                      }))
                    }
                  />
                </div>
              ...
              <div className="ds-field-row">
                <div className="ds-field">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, reset_cycle: e.target.value }))
                    }
                  >
              ...
              <div className="ds-switch-grid">
                <Switch
                  ...
                  onChange={(v) =>
                    setForm((p) => ({ ...p, weekends_covered: v }))
                  }
                />
                <Switch
                ...
                <Switch
                  ...
                  onChange={(v) =>
                    setForm((p) => ({ ...p, workload_interchange: v }))
                  }
                />
                <Switch
                  ...
                  onChange={(v) =>
                    setForm((p) => ({ ...p, document_required: v }))
                  }
                />
              </div>
              ...
              <div className="ds-field" style={{ marginTop: 24 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({ ...p, total_days: e.target.value }))
                  }
                />
              </div>
            </div>
...
function Switch({
  ...
  return (
    <div className="ds-switch-field">
      ...
      <div
        className={`ds-switch${active ? " active" : ""}`}
