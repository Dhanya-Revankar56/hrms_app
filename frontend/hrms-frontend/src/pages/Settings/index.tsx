...
import type { SidebarItem } from "./components/SettingsSidebar";
...
import EmployeeTypeSection from "./components/EmployeeTypeSection";
import UserManagementSection from "./components/UserManagementSection";
import AppearanceSection from "./components/AppearanceSection";
import InstitutionSection from "./components/InstitutionSection";
import MovementRegisterSection from "./components/MovementRegisterSection";
...
export default function Settings() {
  ...
  const filteredItems = isAdmin
    ...
    : SIDEBAR_ITEMS.filter((item) =>
        ["appearance", "security"].includes(item.key),
      );

  const [activeKey, setActiveKey] = useState(
    isAdmin ? "departments" : "appearance",
  );
    ...
    <>
      ...
      <div className="settings-page">
        ...
        <div className="settings-layout">
          ...
          <div className="settings-content">{renderSection(activeKey)}</div>
        </div>
      </div>
    </>
  );
