...
// Sections
import EmployeeHeaderSection from "./components/sections/EmployeeHeaderSection";
import EmployeeFilterSection from "./components/sections/EmployeeFilterSection";
import EmployeeTableSection from "./components/sections/EmployeeTableSection";
import EmployeePaginationSection from "./components/sections/EmployeePaginationSection";
...
interface BackendEmployee {
  ...
  work_detail?: {
    department?: { id: string; _id?: string; name: string };
    designation?: { id: string; _id?: string; name: string };
...
/* ─────────────────────────────────────────────
   MAPPERS & HELPERS
 ───────────────────────────────────────────── */
function mapBackendToManaged(b: BackendEmployee): ManagedEmployee {
  return {
    id: b.id,
  ...
  return (
    <div className="em-container">
      ...
      <EmployeeHeaderSection
        ...
        activeCount={employeesData?.getAllEmployees?.activeCount || 0}
        onLeaveCount={employeesData?.getAllEmployees?.onLeaveCount || 0}
      />
