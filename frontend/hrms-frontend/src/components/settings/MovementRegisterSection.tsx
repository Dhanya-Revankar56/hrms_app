        ...
        <div className="mv-modal-overlay">
          <div className="mv-modal">
            <div className="mv-modal-header">
              <div className="mv-modal-title">Edit Movement Register Settings</div>
            </div>
            
            <div className="mv-modal-body">
              <div className="mv-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div className="mv-form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setForm({...form, limit_count: parseInt(e.target.value) || 0})}
                  />
                </div>
                <div className="mv-form-group">
                  <label>Limit Frequency</label>
                  <select 
                    ...
                    onChange={(e) => setForm({...form, limit_frequency: e.target.value})}
                  >
              ...
              <div className="mv-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div className="mv-form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setForm({...form, max_duration_mins: parseInt(e.target.value) || 0})}
                  />
                </div>
                <div className="mv-form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setForm({...form, days_before_apply: parseInt(e.target.value) || 0})}
                  />
                </div>
              </div>
              ...
              <div className="mv-toggle-group">
                ...
                <input 
                  ...
                  onChange={(e) => setForm({...form, user_entry: e.target.checked})}
                />
              </div>
              ...
              <div className="mv-toggle-group">
                ...
                <input 
                  ...
                  onChange={(e) => setForm({...form, limit_enabled: e.target.checked})}
                />
              </div>
            </div>

            <div className="mv-modal-footer">
              <button className="mv-btn mv-btn-cancel" onClick={() => setIsEditing(false)}>Cancel</button>
              <button className="mv-btn mv-btn-save" onClick={handleSave} disabled={saving}>
