...
async function migrate() {
  try {
    ...
    console.log("📋 Updating Leave approval roles from 'HOD' to 'HEAD OF DEPARTMENT'...");
    const leaveResult = await mongoose.connection.db.collection("leaves").updateMany(
      { "approvals.role": "HOD" },
