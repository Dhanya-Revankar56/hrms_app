...
async function testGQL() {
  ...
  await runWithTenant(tenantId, async () => {
    ...
    console.log(res1.errors ? JSON.stringify(res1.errors, null, 2) : JSON.stringify(res1.data.relievings.items[0], null, 2));
    ...
    console.log(res2.errors ? JSON.stringify(res2.errors, null, 2) : `Holidays found: ${res2.data.holidays.length}`);
    ...
    console.log(res3.errors ? JSON.stringify(res3.errors, null, 2) : JSON.stringify(res3.data.dashboardStats, null, 2));
