...
async function resetData() {
  try {
    ...
    const counterResult = await mongoose.connection.collection("counters").deleteMany({ model_name: "employee" });
    console.log(`Reset employee ID counters (${counterResult.deletedCount} counter records removed)`);
